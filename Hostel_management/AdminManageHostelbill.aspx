<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminManageHostelbill.aspx.cs" Inherits="_Default" %>
                    ...
                    <td>
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="hostel_bill_id" Visible="False"></asp:BoundColumn>
                                 ...
                                 <asp:BoundColumn DataField="hostel_fee_amount" HeaderText="Fee Amount"></asp:BoundColumn>
                                <asp:BoundColumn DataField="payment_status" HeaderText="Payment status"></asp:BoundColumn>
