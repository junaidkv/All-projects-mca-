<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="admin_hospitals.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            ...
            <p>
                <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Registered Hospitals</strong></p>
            <asp:DataGrid ID="DataGrid1" runat="server" CellPadding="4" ForeColor="#333333" 
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="login_id" Visible="False"></asp:BoundColumn>
                    ...
                    <asp:BoundColumn DataField="district" HeaderText="District"></asp:BoundColumn>
                     <asp:BoundColumn DataField="user_type" HeaderText="Status"></asp:BoundColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Approve/Reject">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="a" Height="22px" 
                                ImageUrl="~/images/approve.png" Width="24px" />
                            &nbsp;&nbsp;&nbsp;
                            <asp:ImageButton ID="ImageButton2" runat="server" CommandName="r" Height="25px" 
                                ImageUrl="~/images/reject.png" Width="24px" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
