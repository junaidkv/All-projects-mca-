...
<table align="center" class="table" style="width: 700px;">
 ...
 <tr>
	<th> First Name </th>
<td> <input type="text" name="firstname" value="<?php echo $row['user_firstname'];?>"> </td> 
</tr>


<tr>
	<th> Last Name </th>
	<td> <input type="text" name="Hlastname" value="<?php echo $row['user_lastname'];?>"> </td> 
</tr>


<tr>
	<th> Phone Number </th>
	<td> <input type="number" name="Hnumber" value="<?php echo $row['user_mobile'];?>"> </td> 
</tr>
