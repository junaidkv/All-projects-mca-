						...
						<h2 align="center">Login to your account</h2>
							...
							<table align ="center" class="table" style="width: 400px;">
								...
								<tr>
									...
									<td colspan="2" align="center"> <input type="submit" name="login" value= "LOGIN" class="btn btn-primary" style="color: white; width: 150px;"> </td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2" align="center"> <button style="width: 400px;"><a href="useregistration.php" style="color: white;">SignUp</button> </td>
								</tr>
...
{
   extract($_POST);
	$qr="SELECT * from user where user_email='$username' AND user_password='$password'";
	$res=select($qr);
	if(sizeof($res)>0)
	{
		$id=$res[0]['user_id'];
