				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<!-- <li><a href="index.html">Home</a></li>
								 -->
								 <!-- <li class="dropdown"><a href="AMP_manageproduct.php">products<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.html">Image upload</a></li>
								
										<li><a href="shop.html">Size Upload</a></li> 
                                    </ul>
                                </li>  -->
						...
						<!-- 	</ul>
								...
								<!-- <li><a href="adminvieworder.php"><i class="fa fa-user"></i>View orders</a></li> -->
							...
							<div class="product-image-wrapper"> -->
								...
								<!-- <div class="single-products"> -->
										<!-- <div class="productinfo text-center"> -->
											...
											<a href="login.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
										<!-- </div> -->
